      ...
      <div className={"center-container nav-container " + color}>
        <nav className="center-margin">
          <div className="links">
            ...
            <div className="right">
              <span
                className={email == "Copy" ? "copy" : null}
                onMouseEnter={() => setEmail("Copy")}
                onMouseLeave={() => setEmail("Email")}
              ...
              <a
                target="_blank"
                href="https://drive.google.com/file/d/1U0AJPrG909dLFF1XYzdgvRwTwCsGpqow/view?usp=sharing"
              >
                Resume
              </a>
            </div>
...
const Website = ({ year, title, stack, link, color, order }) => {
  if (typeof window !== "undefined") {
    return (
      <a className={"website"} href={link} rel="noreferrer">
  ...
  return (
    <footer className="center-margin">
      ...
      <div className="links">
        ...
        <div className="right">
          <a target="_blank" href="https://instagram.com/ndrewgood">
            IG
          </a>
          <a target="_blank" href="https://www.linkedin.com/in/ndrewgood/">
            LI
          </a>
          <a target="_blank" href="https://github.com/ndrewgood/">
            GH
          </a>
          <a target="_blank" href="https://www.are.na/andrew-goodridge">
            AR
          </a>
        </div>
      </div>
      ...
      >
        My website is a time machine to past versions of myself. <br />
        What could yours be?
      </a>
    </footer>
  )
...
const Paragraphs = () => {
  ...
  return (
    <>
      <img
        className="andrew"
        src={images[andrewOrder].src}
        alt={images[andrewOrder].alt}
        style={{
          width: images[andrewOrder].width,
          top: mouse[1] + 20 + "px",
          left: mouse[0] + 20 + "px",
          display: andrewStatus ? "block" : "none",
        }}
      />
      <p className="first center-margin">
        My name is{" "}
        <a
          className="noselect andrew-photos"
          onMouseMove={e => setMouse([e.clientX, e.pageY])}
          onMouseEnter={() => {
            setAndrewStatus(true)
            displayAndrew()
          }}
          onMouseLeave={() => setAndrewStatus(false)}
          onClick={() => displayAndrew()}
          onKeyDown={e => {
            if (e.key === "Enter") displayAndrew()
          }}
          role="button"
          tabIndex={0}
        >
        ...
        <span className="andrew-noPhotos">Andrew</span> Goodridge, I'm a
        designer and developer who loves to make digital products of all shapes
        and sizes, currently working at{" "}
        <a target="_blank" href="https://design.google" rel="noreferrer">
          Google
        </a>{" "}
        as an Interaction Designer.
      </p>
      <p className="center-margin">
        While my website is currently <i>under construction</i>, I thought that
        this would be a great opportunity to publicly archive my past personal
        websites. More coming soon...
      </p>
      <p className="center-margin">
        Always open to chat, feel free to reach out via{" "}
        <a href="mailto:hey@ndrewgood.com" rel="noreferrer">
          email
        </a>{" "}
        or DM on any of my social channels! ✌️
      </p>
    </>
  )
}
...
const IndexPage = () => {
  const bgColors = ["bg-tan", "bg-green", "bg-blue", "bg-purple", "bg-yellow"]
  ...
  return (
    <Layout>
      ...
      <Website
        year="Nov. 2017 - July 2018"
        title="My first website"
        stack="Jekyll, Github Pages"
        link="https://2017.ndrewgood.com"
        color={bgColor}
        order={colorOrder}
      />
      {/* https://github.com/ndrewgood/pwb3-gatsby */}
      <Website
        year="July 2018 - Sept. 2018"
        title="First Gatsby website"
        stack="Gatsby, Github Pages"
        link="https://2018.ndrewgood.com"
        color={bgColor}
        order={colorOrder}
      />
      ...
      <Website
        ...
        title="Freshman year portfolio"
        stack="Vanilla, Github Pages"
        link="https://2019.ndrewgood.com"
        color={bgColor}
        order={colorOrder}
      />
      {/* https://github.com/ndrewgood/website2020 */}
      <Website
        year="Aug. 2019 - July 2020"
        title="Sophomore year portfolio"
        stack="Vanilla, Firebase"
        link="https://2020.ndrewgood.com"
        color={bgColor}
        order={colorOrder}
      />
      ...
      <Website
        ...
        title="Junior year portfolio"
        stack="Gatsby, Sanity, Netlify"
        link="https://2021.ndrewgood.com"
        color={bgColor}
        order={colorOrder}
      />
      <Footer />
